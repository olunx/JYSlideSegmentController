...
- (instancetype)initWithViewControllers:(NSArray *)viewControllers {
    ...
    if (self) {
        ...
        _segmentTitleFont = [UIFont systemFontOfSize:12.0f];
        _segmentBarHeight = 44.0f;
        _segmentIndicatorHeight = 3.0f;
    }
    return self;
}
...
- (UIView *)indicatorBgView {
    if (!_indicatorBgView) {
        CGRect frame = CGRectMake(0, self.segmentBar.frame.size.height - _segmentIndicatorHeight - 1,
                self.view.frame.size.width / self.viewControllers.count, _segmentIndicatorHeight);
...
- (UIView *)indicator {
    if (!_indicator) {
        ...
        CGRect frame = CGRectMake(self.indicatorInsets.left, 0, width, _segmentIndicatorHeight);
...
- (void)setIndicatorInsets:(UIEdgeInsets)indicatorInsets {
    ...
    frame.size.height = _segmentIndicatorHeight;
...
- (UICollectionViewFlowLayout *)segmentBarLayout {
    if (!_segmentBarLayout) {
        ...
        _segmentBarLayout.itemSize = CGSizeMake(self.view.frame.size.width / self.viewControllers.count, _segmentBarHeight);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    segmentBarItem.titleLabel.textColor = _segmentTitleColor;
    segmentBarItem.titleLabel.font = _segmentTitleFont;
